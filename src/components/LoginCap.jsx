...
function LoginCaptain() {
    ...
    return (
        <div style={{
            ...
            {/* Left Side - Vibrant Uber Gradient */}
            <div style={{
                flex: '1.2',
                background: `
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <p style={{
                            ...
                            Join the world's largest ride-sharing platform and start earning money driving on your own schedule.
                        </p>
                    </div>
                    ...
                    <div style={{
                        ...
                        {[
                            { icon: '💸', title: 'High Earnings', desc: 'Up to $25/hour' },
                            { icon: '⏰', title: 'Flexible Hours', desc: 'Drive when you want' },
                            { icon: '🛡️', title: 'Safety First', desc: 'Secure & protected' },
                            { icon: '🌎', title: 'Global Reach', desc: 'Worldwide network' }
                        ].map((item, i) => (
                            <div key={i} style={{
                ...
                <div style={{
                    ...
                    <div style={{ marginBottom: '50px', textAlign: 'center' }}>
                        ...
                        <p style={{
                            ...
                            fontWeight: '400',
                            margin: '0'
                        }}>Sign in to your captain dashboard</p>
                    </div>
                        ...
                        <div style={{ textAlign: 'center', marginBottom: '25px' }}>
                            <span style={{
                                ...
                                <span 
                                    ...
                                    onClick={() => window.location.href = '/signup-captain'}
                                    onMouseEnter={(e) => {
