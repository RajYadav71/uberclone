...
function App() {
  ...
  // If signup/login/get-started clicked, show Signup.jsx
  if (showSignup) {
    return <Signup />;
  }
    ...
    <a href="#" className="dropdown-item">Investor Relations</a>
          ...
          <div className="header-right">
            ...
            <a
              ...
              onClick={(e) => {
                e.preventDefault();
                setShowSignup(true); // open Signup.jsx
              }}
            >
              Log in
            </a>
            <button
              ...
              onClick={() => setShowSignup(true)} // open Signup.jsx
            >
              Sign up
            </button>
          </div>
      ...
      <div className="sub-nav">
        <div className="sub-nav-container">
          ...
          <nav className="sub-nav-links">
            <a href="#" className="sub-nav-link">Requirements</a>
            <a href="#" className="sub-nav-link">Driving basics</a>
            <a href="#" className="sub-nav-link">Earnings</a>
            <a href="#" className="sub-nav-link">Deactivations</a>
            <a href="#" className="sub-nav-link">Safety</a>
            <a href="#" className="sub-nav-link">Uber Pro</a>
            <a href="#" className="sub-nav-link">Contact us</a>
          </nav>
        </div>
      </div>
